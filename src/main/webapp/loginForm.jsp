								...
								<h6 class="font-weight-light">계속 진행하시려면 로그인을 해주세요</h6>
	              				<form class="pt-3">
									<div class="form-group">
										<input type="text" class="form-control form-control-lg" id="id" placeholder="Member Id" name="memberId">
									</div>
									<div class="form-group">
										<input type="password" class="form-control form-control-lg" id="pw" placeholder="Password" name="memberPw">
									</div>
									<div class="mt-3">
										<button type="button" id="loginBtn" class="btn btn-block btn-info btn-lg font-weight-medium auth-form-btn">로그인</button>
									</div>
									<div>
										<%
    	...
    	let signinBtn = document.querySelector('#loginBtn');
 		...
 		signinBtn.addEventListener('click', function(){
        	...
        	let id = document.querySelector('#id');
         	...
         	loginForm.submit(); // action="./loginAction.jsp"
 		});
	</script>
</body>
</html>